...
he useRouteMatch hook is useful any time you are using a <Route> just so you can get access to its match data, including all of the times you might render a <Route> all by itself outside of a <Switch>

1. How would you explain form validation to someone who has never programmed before?
it checks the code works properly


1. In 1-2 sentences, define end to end testing.
it allows to verify the code works. It goes through each variable.
